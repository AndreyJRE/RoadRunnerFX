...
//		subSceneCenter.setCache(true);
//		subSceneCenter.setCacheHint(CacheHint.SPEED);
//		root.cacheHintProperty().set(CacheHint.SPEED);
		...
		labelBox.getChildren().addAll(levelLabel, scoreLabel, changeViewButton);
